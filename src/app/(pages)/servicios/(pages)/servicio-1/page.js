...
export default function Servicio1() {
  ...
  return (
    <main>
      <section
        id="main-section"
        className="h-100-vh flex justify-content-between align-items-center"
      >
        <Image
          src={quequen}
          alt="algo"
        ...
        <div className={`${classes.box_info}`}>
          <h1 className="fs-3 mb-1">Servicio 1</h1>
          <p>
          ...
          <CustomLinkButton href="#gallery-section" black className="mt-2">
            Ver Imagenes
          </CustomLinkButton>
        </div>
      </section>
